...
@testset "NACA 0012 Boeing-Vertol" begin
    ...
    function runme()
        ...
        for t = 0:dt:tmax
            ...
            CL_BV[i], CD_BV[i], CM_BV[i], BV_DynamicFlagL, BV_DynamicFlagD = VAWTAero.Boeing_Vertol(af,alpha_BV[i+1],adotnorm,M,Re,aoaStallPos,aoaStallNeg,AOA0,tc,BV_DynamicFlagL,BV_DynamicFlagD, family_factor = 0.0)
            i += 1
        end
...
#             # Juno.@enter VAWTAero.Leishman_Beddoes!(af,alpha_LB[i],alpha_LB[i],ds,M,Re,CLa,AOA0,CLCritP,CLCritN,CLRefLE_Last, CLRef_Last,Fstat_Last, cv_Last, dp, dF, dCNv, LESepState, Tp=1.7, family_factor = 0.0)
#             CL_LB[i], CD_LB[i], CM_LB[i], CLRefLE_Last,CLRef_Last,Fstat_Last,cv_Last, dp, dF, dCNv, LESepState, sLEv = VAWTAero.Leishman_Beddoes(af,alpha_LB[i],alpha_LB[i],ds,M,Re,CLa,AOA0,CLCritP,CLCritN,CLRefLE_Last, CLRef_Last,Fstat_Last, cv_Last, dp, dF, dCNv, LESepState, sLEv, Tp=1.7, family_factor = 0.0)
#             i += 1
#         end
