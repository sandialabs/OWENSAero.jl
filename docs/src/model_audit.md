...
| Unsteady wake and RPI | Implemented for single-turbine workflows. | Examples and tests pin representative unsteady histories and whole-revolution averaging windows. | Add timestep-sensitivity and aliasing diagnostics; validate clockwise and multi-rotor behavior before expanding support. |
